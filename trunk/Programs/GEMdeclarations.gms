...
Parameters
  ...
  modelledHydroOutput(g,y,t,scenarios)          'Hydro output used in each modelled year by scheduleable hydro plant'
  allModelledHydroOutput(experiments,steps,scenarioSets,g,y,t,scenarios) 'Collect the hydro output used in each modelled year by scheduleable hydro plant for all experiments-steps-scenarioSets tuples'
...
Equations
  ...
  limit_hydro(g,y,t,scenarios)                  'Limit hydro generation to according to inflows'
...
* Equations (ignore the objective function)
  ...
  s_limit_hydro(steps,scenarioSets,g,y,t,scenarios)              'Limit hydro generation to according to inflows'
